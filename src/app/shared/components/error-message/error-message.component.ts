...
export class ErrorMessageComponent {
  ...
  private errorMessages: { [key: string]: any } = {
    ...
    minlength: (params: any, name: any) =>
      `Length of ${name} can not lower than ${params.requiredLength} characters`,
    maxlength: (params: any, name: any) =>
      `Length of ${name} can not exceed ${params.requiredLength} characters`,
